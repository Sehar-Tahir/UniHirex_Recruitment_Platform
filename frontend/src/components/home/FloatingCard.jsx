...
export default function FloatingCard({ avatarGradient, name, role, extra, tagBg, tagColor, tagText, floatClass, position }) {
  return (
    <div
      className={`absolute bg-white rounded-2xl px-5 py-4 shadow-[0_24px_48px_-16px_rgba(10,16,40,0.35)] w-[230px] sm:w-[240px] ${floatClass}`}
      style={{ ...position, ...fontBody }}
    >
      <div className="flex items-center gap-2.5 mb-1">
        <div className="w-9 h-9 rounded-full flex-shrink-0" style={{ background: avatarGradient }} />
        <div>
