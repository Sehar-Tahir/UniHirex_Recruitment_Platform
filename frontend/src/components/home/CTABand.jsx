...
export default function CTABand() {
  return (
    <section className="pb-20 md:pb-24 px-5 md:px-8">
      <div
        className="max-w-279 mx-auto rounded-[28px] px-7 md:px-16 py-14 md:py-16 text-center text-white relative overflow-hidden"
        style={{ background: `linear-gradient(120deg, ${COLORS.accent}, ${COLORS.primary})` }}
      >
        <div
